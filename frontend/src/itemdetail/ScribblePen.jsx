...
const ScribblePen = ({ addToCart }) => {
  ...
  const packOptions = [
    ...
    { label: "Set of 3", value: "Set of 3", price: 420, quantity: 1 },
    { label: "Set of 10", value: "Set of 10", price: 1300, quantity: 1 },
  ...
  return (
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {productDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Premium" ? <WorkspacePremium fontSize="small" /> : <Create fontSize="small" />}
                  sx={{
      ...
      <Snackbar
        ...
        message="✓ Scribble Pen added to cart!"

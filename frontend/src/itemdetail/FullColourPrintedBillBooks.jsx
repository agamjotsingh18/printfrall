...
const FullColourPrintedBillBooks = ({ addToCart }) => {
  const priceMapping = {
    "A5 Size": 150,
    "A4 Size": 250,
    "A5 Size (Magnetic)": 200,
    "A4 Size (Magnetic)": 300,
  };

  const sizes = ["A5 Size", "A4 Size", "A5 Size (Magnetic)", "A4 Size (Magnetic)"];
  ...
  const unitPrice = priceMapping[selectedSize]; // per bill book (50 sheets)
  ...
  const productDetails = {
    ...
    features: [
      ...
      "Magnetic option available for fridges or desks",
      "Upload your design or personalize online",
      "Can also be used as custom Notepads",
  ...
  const handleAddToCart = () => {
    ...
    if (selectedOption === "Custom") {
      item = {
        ...
        selectedSize: `${customQuantity} pads (${selectedSize})`,
  ...
  return (
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {productDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "90 GSM" ? <MenuBook fontSize="small" /> : <WorkspacePremium fontSize="small" />}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" sx={{ mb: 3, color: "#1e2a32", lineHeight: 1.6 }}>
            ...
            <strong style={{ color: "#19485D", display: "block", marginTop: "8px" }}>
              We have thousands of design options available to choose from. Please contact us for more designs.
            </strong>
          </Typography>
          ...
          {selectedOption === "Custom" && (
            <Box sx={{ mb: 4 }}>
              ...
              <TextField
                ...
                InputProps={{
                  endAdornment: <InputAdornment position="end">pads</InputAdornment>,
                }}
                sx={{
                  width: "180px",
      ...
      <Snackbar
        ...
        message="✓ Bill Books added to cart!"

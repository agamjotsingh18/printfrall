...
const LuggageTags = ({ addToCart }) => {
  ...
  const packOptions = [
    { label: "Single", value: "Single", price: 299, quantity: 1 },
    { label: "Pack of 3", value: "Pack of 3", price: 799, quantity: 1 },
    { label: "Pack of 5", value: "Pack of 5", price: 1199, quantity: 1 },
    { label: "Custom", value: "Custom", price: null, quantity: null },
  ];

  const unitPrice = 299; // Price per single tag
  ...
  const productDetails = {
    ...
    features: [
      ...
      "Customizable with laser-carved names or initials",
      "Laser engraving ensures the design lasts forever",
      "Secure buckle attachment with metal hardware",
      "Available in multiple premium earthy tones",
      "Ideal for corporate gifting, doctors, and frequent flyers",
      "Helps identify bags quickly at airport carousels",
    ],
  ...
  const handleAddToCart = () => {
    ...
    if (selectedOption.value === "Custom") {
      item = {
        ...
        selectedSize: `${customQuantity} tags`,
    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {productDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Executive" ? <WorkspacePremium fontSize="small" /> : <Luggage fontSize="small" />}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          {selectedOption.value === "Custom" && (
            <Box sx={{ mb: 4 }}>
              ...
              <TextField
                ...
                InputProps={{
                  endAdornment: <InputAdornment position="end">tags</InputAdornment>,
                }}
                sx={{
                  width: "180px",
              ...
              <Typography variant="caption" sx={{ display: "block", mt: 1, color: "#5a6e7a" }}>
                Unit price: ₹{unitPrice} per tag
              </Typography>
            </Box>
          )}

          {/* Color / Leather Tone Selection */}
          <Typography
            variant="h6"
            sx={{ fontWeight: 600, mb: 2, color: "#19485D", fontSize: { xs: "1.2rem", md: "1.5rem" } }}
          >
          ...
          >
            * Permanent laser engraving provided by PrintfrAll High-Resolution technology.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message="✓ Luggage Tag added to cart!"

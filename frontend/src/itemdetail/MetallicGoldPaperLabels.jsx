...
const MetallicGoldPaperLabels = ({ addToCart }) => {
  ...
  const priceMapping = {
    "Subtle Matte Gold": 150,
    "Brushed Metallic Gold": 180,
    "Antique Gold Paper": 165,
  };
  ...
  const productDetails = {
    ...
    description:
      "Indulge your brand with subtle gold paper labels. Crafted from premium 80 GSM gold sticker paper with a sophisticated matte finish, these labels are designed to add a touch of elegance and unmatched appeal to luxury product packaging, event invitations, and high-end branding.",
    features: [
      "Material: Premium 80 GSM Gold Sticker Paper",
      "Finish: Subtle matte metallic sheen for a premium touch",
      "Adhesive: Strong self-adhesive backing for easy application",
    ...
    >
      <Grid container spacing={5}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Sophisticated branding solutions powered by PrintfrAll Gold Paper Technology.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message={`✓ Pack of ${moq} Gold Labels added to cart!`}

...
const EliteHorizonLaptopBag = ({ addToCart }) => {
  ...
  const availableColors = ["Khadi Grey"];
  const defaultSize = "30 Litre";
  ...
  const bagDetails = {
    ...
    features: [
      "30 Litre High Capacity storage",
      "Premium Khadi Grey fabric construction",
      "2 Full compartments + dedicated padded laptop section",
      "Side pocket for water bottle holder",
    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Custom embroidery available for bulk orders starting from 10 units.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message="✓ Prominent Laptop Bag added to cart!"

...
const EcoGripNotebook = ({ addToCart }) => {
  ...
  const packOptions = [
    ...
    { label: "Pack of 5", value: "Pack of 5", price: 1650, quantity: 1 },
    { label: "Pack of 10", value: "Pack of 10", price: 3150, quantity: 1 },
  ...
  const productDetails = {
    ...
    features: [
      "Sustainable design with eco-friendly cardboard pen",
      "Undated 140-page journal for task tracking",
      "Premium 70gsm paper for a smooth writing surface",
      "Integrated card pocket for notes, cards, and receipts",
      "Stick-on writing pad included to reduce waste",
      "Clear front cover customizable with your printed logo",
    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {productDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Eco-Friendly" ? <Nature fontSize="small" /> : <Style fontSize="small" />}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Powered by PrintfrAll High-Resolution Custom Branding Technology.
          </Typography>
        </Grid>
      </Grid>

...
const SkateBallpointPen = ({ addToCart }) => {
  ...
  const packOptions = [
    ...
    { label: "Pack of 3", value: "Pack of 3", price: 420, quantity: 1 },
    { label: "Pack of 10", value: "Pack of 10", price: 1300, quantity: 1 },
    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {skateDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Sheer Quality" ? <WorkspacePremium fontSize="small" /> : <Create fontSize="small" />}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Personalization powered by PrintfrAll high-precision laser engraving.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message="✓ Skate Pen added to cart!"

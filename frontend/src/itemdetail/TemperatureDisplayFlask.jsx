...
const TemperatureDisplayFlask = ({ addToCart }) => {
  ...
  // Available options
  const availableColors = ["Matte Black"];
  ...
  const productDetails = {
    ...
    features: [
      ...
      "Ergonomic easy-grip body design",
      "One-handed flip-top sports cap",
      "Integrated carry loop for portability",
      "BPA-free and non-toxic stainless steel",
    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {productDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Sports" ? <FitnessCenter fontSize="small" /> : null}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Personalization available via PrintfrAll High-Resolution Custom Engraving.
          </Typography>
        </Grid>
      </Grid>

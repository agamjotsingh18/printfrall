...
const SlimSSBottle = ({ addToCart }) => {
  ...
  // Available options
  const availableColors = ["Matte Black", "Matte Silver", "Matte Navy"];
  ...
  const productDetails = {
    ...
    features: [
      "750 ML Capacity",
      "Spill-proof cap with carrying strap",
      "Personalized with your logo or artwork (1.5 x 3 inches)",
      "BPA Free & Non-Toxic Stainless Steel",
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body2" sx={{ mt: 2, color: "#5a6e7a", fontStyle: "italic", textAlign: "center" }}>
            * Perfect for corporate branding with custom logo printing options.
          </Typography>
        </Grid>
      </Grid>

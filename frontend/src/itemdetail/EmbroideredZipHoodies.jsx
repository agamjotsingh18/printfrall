...
// ========== MAIN PRODUCT IMAGE ==========
import mainImg from "../assets/embroidered-zip-hoodie.png";

// ========== EXTRA ANGLES ==========
import img2 from "../assets/embroidered-zip-hoodie.png";
import img3 from "../assets/embroidered-zip-hoodie-1.png";
import img4 from "../assets/embroidered-zip-hoodie-2.png";
import img5 from "../assets/embroidered-zip-hoodie-3.png";

const EmbroideredZipHoodies = ({ addToCart }) => {
  const priceMapping = {
    "Heavy Blend Fleece": 1350,
  };

  const availableColors = [
    "Black", "Navy", "Sports Grey", "Red", "Royal Blue",
    "Irish Green", "Purple", "White", "Dark Grey"
  ];
  const availableSizes = ["S", "M", "L", "XL", "2XL", "3XL"];

  const defaultMaterial = "Heavy Blend Fleece";
  ...
  const unitPrice = priceMapping[selectedMaterial]; // per hoodie
  ...
  const productDetails = {
    name: "Embroidered Zip-Through Hoodie",
    image: mainImg,
    description:
      "Premium Gildan Heavy Blend™ zip-through hood crafted for superior branding impact. Featuring a covered metal zipper for seamless chest embroidery, this 270 GSM polycotton fleece offers air-jet spun yarn for a softer feel and reduced pilling.",
    features: [
      "Material: 270 GSM Polycotton Fleece (52% Poly, 48% Cotton)",
      "Branding: Precision Embroidery (Front/Left Chest/Back)",
      "Air Jet Spun Yarn for soft-touch and anti-pill finish",
      "Covered metal zipper designed for full chest decoration",
      "Unlined hood with color-matched drawstring",
      "1x1 athletic rib with Lycra® for stretch and recovery",
      "Double-needle stitching at waistband and cuffs",
    ],
    tags: ["High-Stitch Count", "Covered Zipper", "Anti-Pill"],
    colors: availableColors,
    sizes: availableSizes,
    materials: ["Heavy Blend Fleece"],
    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {productDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Anti-Pill" ? <VerifiedUser fontSize="small" /> : <Checkroom fontSize="small" />}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          {selectedOption === "Custom" && (
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="caption" sx={{ display: "block", mt: 1, color: "#5a6e7a" }}>
                Unit price: ₹{unitPrice} per hoodie
              </Typography>
            </Box>
          )}
          ...
          >
            * Note: Professional embroidery supports up to 6 thread colors per design.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message="✓ Embroidered Zip Hoodie added to cart!"

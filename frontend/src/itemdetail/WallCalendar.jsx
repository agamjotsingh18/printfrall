...
const WallCalendar = ({ addToCart }) => {
  ...
  const unitPrice = priceMapping[defaultMaterial]; // ₹350

  const packOptions = [
    { label: "Single", value: "Single", price: unitPrice, quantity: 1 },
    { label: "Pack of 5", value: "Pack of 5", price: unitPrice * 5 * 0.95, quantity: 1 }, // 5% discount -> ₹1663
    { label: "Pack of 10", value: "Pack of 10", price: unitPrice * 10 * 0.9, quantity: 1 }, // 10% discount -> ₹3150
    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {calendarDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Full Year View" ? <CalendarMonth fontSize="small" /> : <WorkspacePremium fontSize="small" />}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Same Day Delivery available in select cities. Personalization powered by PrintfrAll.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message="✓ Poster Calendar added to cart!"

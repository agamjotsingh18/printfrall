...
const GoldFoilingStickers = ({ addToCart }) => {
  ...
  const priceMapping = {
    ...
    "Premium Metallic Foil": 250,
    "Embossed Gold Foil": 300,
  };

  const shapes = ["Circle", "Oval", "Square", "Rectangle", "Rounded Corner", "Custom Shape"];
  const sizes = ["2x1\"", "2x2\"", "3x2\"", "3x3\"", "4x2\"", "4x4\"", "5x3\"", "6x3\""];
  ...
  const productDetails = {
    name: "Luxury Gold Foiling Stickers",
    description:
      "Make your designs shine with our dazzling gold foiling stickers. A true statement of style and quality, the shimmering finish instantly elevates the perceived value of your invitations, packaging, and promotional materials. Perfect for high-end branding that leaves a lasting impression.",
    features: [
      "Timeless gold-foil finish for premium sophistication",
      "Available in 6 distinct shapes (or custom shape of your choice)",
      "Choice of 12 sizes ranging from 2x1” to 6x3”",
      "Superior adhesion to any plain or clear surface",
      "Ideal for weddings, product packaging, and corporate gifting",
    ...
    >
      <Grid container spacing={5}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Powered by PrintfrAll High-End Metallic Foiling Solutions.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message={`✓ Pack of ${moq} Gold Foil Stickers added to cart!`}

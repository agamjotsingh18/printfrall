...
const AwardsTrophies = ({ addToCart }) => {
  ...
  const availableMaterials = ["Crystal", "Acrylic", "Metal", "Wooden"];
  ...
  return (
    ...
    >
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Box component="ul" sx={{ ml: 2, mb: 3, listStyleType: "none", p: 0 }}>
            {awardDetails.features.map((feature, idx) => (
          ...
          <Box sx={{ display: "flex", gap: 2, mb: 4, flexWrap: "wrap" }}>
            {awardDetails.sizes.map((size, idx) => (
              <Paper
                key={idx}
      ...
      <Snackbar
        ...
        message="✓ Award Trophy added to cart!"

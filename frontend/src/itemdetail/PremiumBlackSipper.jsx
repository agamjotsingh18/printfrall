...
const PremiumBlackSipper = ({ addToCart }) => {
  ...
  const bottleDetails = {
    ...
    features: [
      ...
      "Personalize with custom logo or text",
      "Logo print size: 1.5 x 3 inches",
      "Multi-colour UV & Screen printing options",
      "Durable and lightweight for easy carrying",
    ],
    sizes: ["750ml"],
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body2" sx={{ mt: 2, color: "#5a6e7a", fontStyle: "italic", textAlign: "center" }}>
            * Professional UV and Screen Printing available via PrintfrAll.
          </Typography>
        </Grid>
      </Grid>

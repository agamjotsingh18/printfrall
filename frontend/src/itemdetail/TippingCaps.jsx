    ...
    <Container sx={{ py: 6, maxWidth: 1200, margin: "40px auto 0 auto", px: { xs: 2, md: 3 } }}>
      <Grid container spacing={4}>
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
              {capDetails.tags.map((tag, idx) => (
                <Chip
                  ...
                  label={tag}
                  size="small"
                  icon={tag === "Tipped Visor" ? <Verified fontSize="small" /> : <Checkroom fontSize="small" />}
                  sx={{
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            * Minimum order starts at 50 units. Precision embroidery by PrintfrAll.
          </Typography>
        </Grid>
      </Grid>
      ...
      <Snackbar
        ...
        message="✓ Tipping Cap added to cart!"
